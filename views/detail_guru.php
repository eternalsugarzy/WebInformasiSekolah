...
<head>
    ...
    .teacher-table th {
        background-color: #f8f9fa; /* Header Abu-abu Muda */
        color: #333;
        font-weight: 700;
    ...
    .teacher-table tr:nth-child(even) {
        background-color: #fbfbfb; /* Warna zebra striping */
    }
    ...
    .pagination > li > a, .pagination > li > span {
        border-radius: 5px; /* Sesuaikan dengan gambar pagination */
        margin: 0 2px;
    }
                        ...
                        <div class="col-md-12 text-center" style="margin-top: 30px;">
                            <ul class="pagination">
                                ...
                                <li class="<?php echo ($halaman_aktif <= 1) ? 'disabled' : ''; ?>">
                                    <a href="detail_guru.php?halaman=<?php echo $halaman_aktif - 1; ?><?php echo $keyword_query; ?>" aria-label="Previous">
                                ...
                                ?>
                                    <li class="<?php echo ($i == $halaman_aktif) ? 'active' : ''; ?>">
                                        <a href="detail_guru.php?halaman=<?php echo $i; ?><?php echo $keyword_query; ?>">
                                            <?php echo $i; ?>
                                        </a>
                                    </li>
                                <?php endfor; ?>
                                ...
                                <li class="<?php echo ($halaman_aktif >= $total_halaman) ? 'disabled' : ''; ?>">
                                    <a href="detail_guru.php?halaman=<?php echo $halaman_aktif + 1; ?><?php echo $keyword_query; ?>" aria-label="Next">
