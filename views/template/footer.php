            ...
            <div class="col-md-4">
                <div class="feature">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Guru-guru kami adalah lulusan terbaik dan berpengalaman di bidangnya.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="feature">
                    <i class="feature-icon fa fa-building"></i>
                    <div class="feature-content">
                        <h4>Fasilitas Lengkap</h4>
                        <p>Laboratorium, perpustakaan, dan sarana olahraga yang modern dan memadai.</p>
                    </div>
                </div>
            </div>
            </div>
